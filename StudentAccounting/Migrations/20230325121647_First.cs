    ...
    public partial class First : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, new DateTime(2023, 3, 25, 15, 16, 47, 484, DateTimeKind.Local).AddTicks(2057), "первый", "aaa", "aaa", "aaa", "aaa" },
                    { 2, new DateTime(2023, 3, 25, 15, 16, 47, 484, DateTimeKind.Local).AddTicks(2059), "второй", "aaa", "aaa", "aaa", "aaa" }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, null, new DateTime(2023, 3, 25, 15, 16, 47, 484, DateTimeKind.Local).AddTicks(1948), "Description 1", 1, "Department 1", 1, "Active" },
                    { 2, null, new DateTime(2023, 3, 25, 15, 16, 47, 484, DateTimeKind.Local).AddTicks(1965), "Description 2", 2, "Department 2", 2, "Active" }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, new DateTime(2023, 3, 25, 15, 16, 47, 484, DateTimeKind.Local).AddTicks(2005), null, "github.com/user1", 1, 1000, "Active", 0 },
                    { 2, new DateTime(2023, 3, 25, 15, 16, 47, 484, DateTimeKind.Local).AddTicks(2007), null, "github.com/user2", 2, 1200, "Active", 0 }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, new DateTime(2023, 4, 24, 15, 16, 47, 484, DateTimeKind.Local).AddTicks(2026), new DateTime(2023, 3, 25, 15, 16, 47, 484, DateTimeKind.Local).AddTicks(2025), null, 1, 1, "Active", "Description 1", "Yes" },
                    { 2, new DateTime(2023, 4, 24, 15, 16, 47, 484, DateTimeKind.Local).AddTicks(2035), new DateTime(2023, 3, 25, 15, 16, 47, 484, DateTimeKind.Local).AddTicks(2035), null, 2, 2, "Active", "Description 2", "Yes" }
                });
